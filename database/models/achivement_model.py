...
class Achievement(Base):
	...
	achivenet_id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
	...
	users: Mapped["UserAchievement"] = mapped_column(back_populates="achivement", cascade="all, delete-orphan")
...
class UserAchievement(Base):
	...
	ua_id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True, index=True)
	user_id: Mapped[int] = mapped_column(Integer, ForeignKey("users.user_id", ondelete="CASCADE"))
	achivement_id: Mapped[int] = mapped_column(Integer, ForeignKey("achivements.achivenet_id", ondelete="CASCADE"))
