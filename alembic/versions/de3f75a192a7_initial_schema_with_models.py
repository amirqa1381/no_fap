...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'accepted', 'declined', name='partnerstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['achivement_id'], ['achivements.achivenet_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('ua_id')
    )
    op.create_index(op.f('ix_user_achievements_ua_id'), 'user_achievements', ['ua_id'], unique=False)
